 ...
 * Use the {@link com.smartplace.drawerfragments.SectionThreeFragment#newInstance} factory method to
...
public class SectionThreeFragment extends Fragment {
     ...
     */
    public static SectionThreeFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_section_three, container, false);
        ...
        Button button = (Button)fragmentView.findViewById(R.id.btnThree);
