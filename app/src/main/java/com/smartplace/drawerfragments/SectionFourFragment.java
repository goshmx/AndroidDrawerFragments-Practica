 ...
 * Use the {@link com.smartplace.drawerfragments.SectionFourFragment#newInstance} factory method to
...
public class SectionFourFragment extends Fragment {
     ...
     */
    public static SectionFourFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_section_four, container, false);
        ...
        Button button = (Button)fragmentView.findViewById(R.id.btnFour);
